  ...
  reducers: {
    addItemToCart(state, actions) {
      ...
      if (existingItem) {
        ...
        const newItemsList = {...state.items.filter(obj=>obj.id !== newItem.id),existingItem};
      ...
      state.totalAmount = state.items.reduce((previousValue,currentItem)=>{previousValue+currentItem.totalPrice},0);
